...
def index():
  ...
  if request.method == "POST":
    ...
    dub('video/' + filename, 'static/outdir', 'en-IN', [translate_lang], storageBucket=None, phraseHints=[], speakerCount=1, voices={translate_lang: f"{translate_lang}-Standard-{voice}"})
